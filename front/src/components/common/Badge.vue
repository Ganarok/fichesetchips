<template>
    ...
    >
        <div
            class="absolute flex items-center justify-center rounded-full left-0 w-full h-full overflow-hidden"
        >
            <img
                class="h-2/3"
        ...
        <div
            v-if="canFav"
            :class="
                (displayFav ? 'bg-fc-yellow ' : 'bg-white ') +
                    'relative bottom-1 rounded-full border-[0.15em] border-fc-yellow cursor-pointer ' +
                    badgeSize.favButton
            "
            style="aspect-ratio: 1/1"
            @click="handleFav"
