<template>
  <SidebarLayout :title="$t('Cartes')">
    ...
    >
      ...
      <div v-else class="flex flex-col flex-wrap sm:flex-row items-start">
        <div
        ...
        >
          ...
          <div class="flex flex-col space-y-3 p-2 bg-gray-50">
            <p class="text-fc-green font-bold">Créer</p>

            <p class="ml-6 text-fc-black-light">Créer une nouvelle carte</p>
          </div>
        </div>
      </div>
    </div>
