<template>
    <SidebarLayout :title="$t('about')">
        <p class="text-justify sm:w-[80%] sm:ml-[10%] lg:w-[70%]">
            ...
            Pour le moment basé sur D&D5, il vise à intégrer un moteur de création de
            campagne, d'univers ainsi qu'un système de création de personnages.
        </p>

        <div class="flex flex-wrap justify-center sm:pb-[3em]">
            <div
                v-for="(member, index) in members"
                :key="member"
                class="flex flex-col items-center bg-gray-100 rounded m-4 py-4 hover:bg-gray-200"
            >
                <img
                    class="w-1/2"
